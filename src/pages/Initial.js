...
const Initial = () => {
  ...
  return (
    <div className="initial-page flex items-center justify-center min-h-screen bg-gray-900">
      <div className="content-wrapper flex flex-col items-center w-full h-full">
        <div className="remote-and-carousel flex flex-col items-center w-full max-w-6xl p-4">
